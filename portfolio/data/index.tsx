  ...
  export const gridItems = [
    {
      ...
      title: "",
      description: "",
      className: "md:col-span-6 md:row-span-4 lg:min-h-[60vh] lg:col-span-3",
  ...
  
    {
      ...
      description: "",
      className: "lg:col-span-2 md:col-span-6 md:row-span-4",
      imgClassName: "absolute left-40 top-20 w-full h-[26rem]",
      titleClassName: "",
      img: "",
      spareImg: "",
    },
    {
      ...
      imgClassName: "w-full h-full justify-center",
